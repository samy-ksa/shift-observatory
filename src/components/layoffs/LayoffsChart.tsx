...
const internationalCases: CaseItem[] = [
  { entity: "Google (Ads)", jobs: 1000, reason: "AI-powered ad products replacing account management", date: "Jan 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "direct" },
  { entity: "Chegg", jobs: 468, reason: "ChatGPT destroying homework help demand", date: "Oct 2025", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "direct" },
  { entity: "Klarna", jobs: 700, reason: "AI assistant replaced 700 FTE equivalent", date: "Feb 2024", status: "confirmed", country: "Sweden", flag: "🇸🇪", ai_role: "direct" },
  { entity: "BT Group", jobs: 10000, reason: "10K of 55K cuts AI/automation by 2030", date: "May 2023", status: "confirmed", country: "UK", flag: "🇬🇧", ai_role: "direct" },
  { entity: "IBM", jobs: 7800, reason: "Hiring freeze on AI-replaceable back-office", date: "May 2023", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "direct" },
  { entity: "Stack Overflow", jobs: 150, reason: "Developers switching to AI assistants", date: "Oct 2023", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "direct" },
  { entity: "Duolingo", jobs: null, reason: "10% contractors replaced by GPT-4 translation", date: "Jan 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "direct" },
  { entity: "Paycom", jobs: 500, reason: "Back-office automation, 8% workforce", date: "Oct 2025", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "contributing" },
  { entity: "Deepwatch", jobs: 70, reason: "AI platform NEXA replaced security analysts", date: "Nov 2025", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "direct" },
  { entity: "Indeed/Glassdoor", jobs: 1300, reason: "AI-powered job matching replacing manual R&D", date: "Jul 2025", status: "probable", country: "US", flag: "🇺🇸", ai_role: "contributing" },
  { entity: "Just Eat Takeaway", jobs: 450, reason: "Customer service and sales admin automated", date: "Sep 2025", status: "probable", country: "Netherlands", flag: "🇳🇱", ai_role: "contributing" },
  { entity: "SAP", jobs: 8000, reason: "Restructuring to focus on AI, largest layoff wave", date: "Jan 2024", status: "probable", country: "Germany", flag: "🇩🇪", ai_role: "contributing" },
  { entity: "UiPath", jobs: 420, reason: "AI automation vendor restructuring own workforce", date: "Jun 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "direct" },
  { entity: "Dropbox", jobs: 500, reason: "AI-first strategy replacing core product teams", date: "Apr 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "direct" },
  { entity: "Cisco", jobs: 5500, reason: "Shifting resources to AI and cybersecurity", date: "Aug 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "contributing" },
  { entity: "Intel", jobs: 15000, reason: "AI strategy pivot, foundry restructuring", date: "Aug 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "contributing" },
  { entity: "Dell Technologies", jobs: 12500, reason: "AI-driven efficiency and sales restructuring", date: "Feb 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "contributing" },
  { entity: "Tesla", jobs: 14000, reason: "Automation and AI integration across operations", date: "Apr 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "contributing" },
  { entity: "Microsoft", jobs: 1900, reason: "Gaming division restructuring post-Activision", date: "Jan 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "suspected" },
  { entity: "Amazon (Alexa)", jobs: 660, reason: "AI pivot, Alexa division restructured for LLMs", date: "Nov 2023", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "direct" },
  { entity: "Spotify", jobs: 1500, reason: "Efficiency drive, AI content tools reducing headcount", date: "Dec 2023", status: "confirmed", country: "Sweden", flag: "🇸🇪", ai_role: "contributing" },
  { entity: "Unity", jobs: 1800, reason: "AI tooling reducing need for manual content teams", date: "Jan 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "contributing" },
  { entity: "Snap", jobs: 540, reason: "Restructuring amid AI-driven ad competition", date: "Feb 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "suspected" },
  { entity: "eBay", jobs: 1000, reason: "AI-powered seller tools reducing support staff", date: "Jan 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "contributing" },
  { entity: "Xerox", jobs: 3000, reason: "AI and automation transforming print operations", date: "Jan 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "contributing" },
  { entity: "DocuSign", jobs: 400, reason: "AI contract analysis reducing manual review teams", date: "Feb 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "contributing" },
  { entity: "Bumble", jobs: 350, reason: "AI matching algorithms reducing curation teams", date: "Feb 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "contributing" },
  { entity: "Workday", jobs: 1750, reason: "AI-driven HR tech reducing own HR operations", date: "Feb 2025", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "suspected" },
  { entity: "Freshworks", jobs: 660, reason: "AI customer service tools consolidating teams", date: "Nov 2024", status: "confirmed", country: "US", flag: "🇺🇸", ai_role: "contributing" },
];
