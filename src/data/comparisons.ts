...
export const COMPARISONS: ComparisonData[] = [
  // 1. NUMBEO
  {
    ...
    features: [
      ...
      },
      {
        ...
        shift: "yes", competitor: "yes",
        shift_detail_en: "26 origin cities, personalized by family size, housing type, school tier",
        shift_detail_fr: "26 villes d'origine, personnalise par taille de famille, type de logement, ecole",
  ...
  // 2. GLASSDOOR
  {
    ...
    features: [
      ...
      { feature_en: "Relocation calculator", feature_fr: "Calculateur de relocation", shift: "yes", competitor: "no", shift_detail_en: "26 origin cities, personalized comparison", shift_detail_fr: "26 villes d'origine, comparaison personnalisee", competitor_detail_en: "Not available", competitor_detail_fr: "Non disponible" },
  ...
  // 6. BAYT
  {
    ...
    features: [
      ...
      { feature_en: "Relocation cost", feature_fr: "Cout de relocation", shift: "yes", competitor: "no", shift_detail_en: "26 origin cities, personalized comparison", shift_detail_fr: "26 villes d'origine, comparaison personnalisee", competitor_detail_en: "Not available", competitor_detail_fr: "Non disponible" },
